...
import { TransactionModuleDependencies, resolveTransactionConfig } from '../modules/transaction/diConfig';
...
export type Dependencies = UsersModuleDependencies & AccountModuleDependencies & TransactionModuleDependencies;
